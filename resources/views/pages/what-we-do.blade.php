...
@section("content")
				<section class="px-6 md:px-12 bg-white" x-data="{ tab: 'protection' }">
								<div class="mx-auto grid max-w-8xl grid-cols-1 gap-8 lg:grid-cols-2">
												...
												<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
																...
																<div class="bg-green-700 rounded-lg shadow-md overflow-hidden">
																				...
																				<div class="p-4">
																								...
																								<p class="text-gray-300 text-sm">Leaders need to put more effort in nabbing perpetrators of child
																												labor…</p>
																				</div>
																</div>
																<!-- News Card -->
																<div class="bg-green-700 rounded-lg shadow-md overflow-hidden">
																				...
																				<div class="p-4">
																								...
																								<p class="text-gray-300 text-sm">NCC introduces new child protection guidelines, as one of the ways
																												to help…</p>
																				</div>
																</div>
																<!-- News Card -->
								...
								<div class="max-w-8xl mx-auto">
												...
												<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
																...
																<a href="#" class="group relative overflow-hidden rounded-lg shadow-md">
																				<img src="{{ asset("images/event1.png") }}" alt="Child Protection Awareness"
																...
																<!-- Event Card -->
																<a href="#" class="group relative overflow-hidden rounded-lg shadow-md">
																				<img src="{{ asset("images/event2.png") }}" alt="School Engagement Session"
																								class="w-full h-56 object-cover transform group-hover:scale-105 transition duration-300">
																				<div
																								class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition duration-300 flex items-center justify-center">
																...
																<!-- Event Card -->
																<a href="#" class="group relative overflow-hidden rounded-lg shadow-md">
																				<img src="{{ asset("images/event3.png") }}" alt="Children’s Rights Week Celebration"
																								class="w-full h-56 object-cover transform group-hover:scale-105 transition duration-300">
																				<div
																								class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition duration-300 flex items-center justify-center">
