								...
								<div class="max-w-7xl mx-auto">
												...
												<div x-show="tab === 'complaint'" class="bg-slate-50 rounded-lg shadow-md p-6 space-y-6">
																...
																<form class="space-y-4">
																				...
																				<button type="submit"
																								class="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-md font-semibold">Submit
																								Complaint</button>
												...
												<div x-show="tab === 'evidence'" class="bg-slate-50 rounded-lg shadow-md p-6 space-y-6">
																...
																<div id="dropZone"
																				...
																				<label for="fileUpload" class="bg-green-600 text-white px-4 py-2 rounded-md cursor-pointer">Choose
																								Files</label>
																...
																<button class="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-md font-semibold">Submit
																				Evidence</button>
